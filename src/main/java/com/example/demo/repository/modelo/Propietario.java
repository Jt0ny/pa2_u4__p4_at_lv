...
public class Propietario {
	...
	@SequenceGenerator(name = "seq_propietario_web",sequenceName = "seq_propietario_web",allocationSize = 1)// el allocationSize de coincidir con el valor que pusimos en el incremento
	@Id
	@Column(name = "prop_id")
	private Integer id;
